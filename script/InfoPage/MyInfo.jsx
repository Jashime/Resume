    ...
    getInitialState:function(){
		return {
			db:[
                ...
                {id:4,icon:'./img/icons/region.png',InfoName:'户籍',Info:'福建 宁德'},
                {id:5,icon:'./img/icons/school.png',InfoName:'毕业院校',Info:'湖南文理学院'},
                {id:6,icon:'./img/icons/education.png',InfoName:'学历',Info:'本科 学士'}
            ]
		}
	},
    render:function(){
